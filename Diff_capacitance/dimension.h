...
public:
	...
	Dimension& set_n_ñ (double emass, double permittivity);	//  n_c_dless  ïîëó÷àåòñÿ äåëåíèåì íà n_0. åñëè n_0 == 0 , òî îíà ïîëàãàåòñÿ ðàâíîé íóëþ.					
	Dimension& set_n_v (double hmass, double permittivity);	//  n_v_dless ò ïîëó÷àåòñÿ äåëåíèåì íà n_0. åñëè n_0 == 0 , òî îíà ïîëàãàåòñÿ ðàâíîé íóëþ.	
